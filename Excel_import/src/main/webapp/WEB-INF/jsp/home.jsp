    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            if (res.status == true) {
            	...
            	Swal.fire('Excel data updated details: Not Empty Data count:' +res.empty_count+',Not correct Mobile No  count:'+res.mobile_count+'');
            	  /* theme = "red";
            	 $.jAlert({
            		  'title': 'Details about bulk insert',
            		  'content': 'Excel data updated details: Empty not inserted count:' +res.empty_count+'Mobile No not correct count:'+res.mobile_count+'',
            		  'theme': theme,
            		  'closeOnClick': true,
                ...
                alert("Couldn't upload the excel");
                $("#upload").prop("disabled", false);
            }
        },
        error: function (msg) {
